...
export default function SuhailPortfolio() {
  ...
  <SectionTitle eyebrow="Selected Work" title="Project case studies" text="Selected projects showing outcomes, architecture, stack choices, and real-world value — not just repository links." />
